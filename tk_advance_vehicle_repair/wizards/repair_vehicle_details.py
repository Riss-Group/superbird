...
class RepairVehicleDetails(models.TransientModel):
    """Repair Vehicle Details"""
    _name = 'repair.vehicle.details'
    ...
    def default_get(self, field):
        res = super(RepairVehicleDetails, self).default_get(field)
        res['repair_job_card_id'] = self._context.get('active_id')
    ...
    def action_add_vehicle_details(self):
        ...
        repair_job_card_id = self.env['repair.job.card'].browse(rec)
        data = {
