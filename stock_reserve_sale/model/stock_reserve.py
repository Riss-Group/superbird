...
class StockReservation(models.Model):
    ...
    def _default_picking_type_id(self):
        if self.sale_id:
            return self.sale_id.warehouse_id.out_type_id.id
        elif self._context.get("warehouse_id", False):
            return self.env["stock.warehouse"].browse(self._context["warehouse_id"]).out_type_id.id
        else:
            return super(StockReservation, self)._default_picking_type_id()