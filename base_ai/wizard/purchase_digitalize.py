...
class PurchaseDigitalize(models.TransientModel):
    _name = 'purchase.digitalize'
    _description = 'Purchase Digitalize'
    ...
    def action_accept(self):
        if self.file:
            ...
            purchase_order = self.env['purchase.order'].browse(id)
            ...
            line_ids = self._get_purchase_order_lines(response_dict)
    ...
    def _get_purchase_order_lines(self, response_dict):
        line_ids = []
